...
/**
 * Controller pour Combobox espece dgal (anima) utilisé dans pondération du
 * risque théorique.
 *
 * @author pegaltier
 */
public class ProduitAnimaComboBoxController extends ListController {
    ...
    protected Collection<?> findBusinesses(BusinessSearchContext businessSearchContext) throws Exception {
        ...
        Join joinCtx = new InnerJoin("ctxTaEspds", "joinCtxTaEspds");
        query.addJoin(joinCtx);
        Expression expression = new SimpleExpression(new Criterion("typeActivite", null, null, "joinCtxTaEspds"),
