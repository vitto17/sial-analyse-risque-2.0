...
/**
 * Service pour gérer si la liste des ponderations Destination à exporter contient ou
 * non des données
 *
 * @author fjperez
 */
public interface ExportPonderationDestinationService extends BusinessService {
