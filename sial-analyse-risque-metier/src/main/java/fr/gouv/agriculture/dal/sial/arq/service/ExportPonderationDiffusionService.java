...
/**
 * Service pour gérer si la liste des ponderations diffusion à exporter contient ou
 * non des données
 *
 * @author fjperez
 */
public interface ExportPonderationDiffusionService extends BusinessService {
