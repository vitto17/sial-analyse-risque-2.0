 ...
 * @author pegaltier
 */
public class PonderationRiThRfaSLComparator implements Comparator<PonderationRiTh>, Serializable {
    ...
    public int compare(PonderationRiTh object1, PonderationRiTh object2) {
        ...
        if (object1 == null) {
            ...
            value = compareColumn(object1.getStringRfaColumnToOrder(), object2.getStringRfaColumnToOrder());
        }
        return value;
    }
