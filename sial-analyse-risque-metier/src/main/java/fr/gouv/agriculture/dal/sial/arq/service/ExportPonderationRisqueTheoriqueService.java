...
/**
 * Service pour gérer si la liste des ponderations Risque Theorique à exporter contient ou
 * non des données
 *
 * @author fjperez
 */
public interface ExportPonderationRisqueTheoriqueService extends BusinessService {
